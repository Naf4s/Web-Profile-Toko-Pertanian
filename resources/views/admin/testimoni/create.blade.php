...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow p-8">
        <h2 class="text-2xl font-bold text-primary mb-6">Tambah Testimoni</h2>
        <form action="{{ route('testimoni.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="isi" rows="3" class="form-input w-full rounded-lg border border-black/70 focus:border-primary focus:ring focus:ring-primary/30" required></textarea>
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 font-semibold mb-2">Jabatan (opsional)</label>
                <input type="text" name="jabatan" class="form-input w-full rounded-lg border border-black/70 focus:border-primary focus:ring focus:ring-primary/30">
            </div>
            <div class="mb-4">
